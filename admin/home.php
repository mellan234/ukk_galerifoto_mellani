...
<head>
    ...
    <style>
        .bg-image {
            background-image: url('../assets/img/galaksi.jpg');
            height: 100vh;
        }
    </style>
</head>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expandede="false" aria-label="Toggle navigation">
...
<div class="container mt-3">
    ...
    <div class="row">
        ...
        if(isset($_GET['albumid'])) {
            ...
            <div class="card">
                <img style="height:12rem" src="../assets/img/<?php echo $data['lokasifile']; ?>" class="card-img-top" title="<?php echo $data['lokasifile'] ?>">
